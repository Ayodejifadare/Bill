...
describe('formatDueDate', () => {
  ...
  it('returns Today when due later the same day', () => {
    expect(formatDueDate('2025-01-15T18:00:00Z')).toBe('Today');
  });

  it('flags overdue payments on the same day', () => {
    expect(formatDueDate('2025-01-15T09:00:00Z')).toBe('Overdue');
  });
