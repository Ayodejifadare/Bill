      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div
              className={`p-3 rounded-full ${securityScore >= 80 ? "bg-green-100" : securityScore >= 60 ? "bg-yellow-100" : "bg-red-100"}`}
            >
              <Shield
                className={`h-6 w-6 ${securityScore >= 80 ? "text-green-600" : securityScore >= 60 ? "text-yellow-600" : "text-red-600"}`}
              />
            </div>
            <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-yellow-600 mt-1">
                  Enable two-factor authentication and use a stronger password
                  to increase your security score.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-3">
          {activities.map((activity) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  className={`p-2 rounded-full ${activity.suspicious ? "bg-red-100" : "bg-green-100"}`}
                >
                  {activity.suspicious ? (
