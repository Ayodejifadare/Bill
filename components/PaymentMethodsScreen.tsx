    ...
    try {
      ...
      toast.error(
        editingMethod
          ...
          : "Failed to verify account. Please check details.",
      );
    } finally {
      setIsLoading(false);
    }
            ...
            <Card>
              <CardContent className="p-6 sm:p-8 text-center">
                ...
                >
                  ...
                  Add Your First{" "}
                  {providers.length > 0 ? "Payment Method" : "Bank Account"}
                </Button>
              </CardContent>
            </Card>
          ) : (
              ...
              if (method.type === "bank") {
                return (
                  <BankAccountCard
                    ...
                    onEdit={(account) =>
                      handleEditMethod(account as PaymentMethod)
                    }
                    variant="personal"
                  />
                );
          ...
          <CardContent className="p-4 sm:p-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-blue-800 leading-relaxed">
                <strong>Secure Payments:</strong> Your payment information is
          ...
          <CardContent className="p-4 pt-0">
            <div className="space-y-4 text-sm text-muted-foreground">
              <div className="flex gap-3">
                <div className="bg-primary text-primary-foreground rounded-full min-w-[24px] h-6 flex items-center justify-center flex-shrink-0 text-xs">
                  1
                </div>
                <p>
                  Add your{" "}
              ...
              <div className="flex gap-3">
                ...
                <p>
                  When you split bills or request money, your payment details
              ...
              <div className="flex gap-3">
                ...
                <p>
                  Friends can send payments directly using{" "}
                  {providers.length > 0
                    ? "their banking or mobile money app"
                    : "their banking app"}
                </p>
              </div>
            </div>
