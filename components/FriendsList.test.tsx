  ...
  it("shows error state and retries", async () => {
    ...
    apiMock
      ...
      .mockResolvedValueOnce({
        friends: [
          { id: "1", name: "Alice", username: "alice", status: "active" },
        ],
      })
    ...
    expect(
      await screen.findByRole("heading", { name: /failed to load friends/i }),
    ).toBeInTheDocument();
    ...
    expect(
      screen.queryByRole("heading", { name: /failed to load friends/i }),
