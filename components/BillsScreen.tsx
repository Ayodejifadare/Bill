      ...
      <ScreenHeader
        ...
        rightAction={
          <Button
            size="sm"
            onClick={() =>
              onNavigate("split", groupId ? { groupId } : undefined)
            }
      ...
      <div className="py-4 space-y-6 pb-20">
                    ...
                    <div className="flex -space-x-2">
                      {bill.participants.map((participant, index) => (
                        <div key={index} className="relative">
                          <Avatar
                            className={`h-8 w-8 border-2 ${participant.paid ? "border-green-500" : "border-yellow-500"}`}
                          >
        ...
        {filteredBills.length === 0 && (
          <EmptyState
            ...
            actionLabel={
              groupId ? "Create Group Split" : "Create Your First Split"
            }
            onAction={() =>
              onNavigate("split", groupId ? { groupId } : undefined)
            }
