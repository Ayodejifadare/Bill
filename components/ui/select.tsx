...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2 rounded-sm py-2.5 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        // Mobile optimizations
        "min-h-[44px] touch-manipulation active:bg-accent/70",
        // Icon and text handling
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:flex *:[span]:items-center *:[span]:gap-2 *:[span]:overflow-hidden *:[span]:text-ellipsis",
        className,
      )}
      {...props}
    >
      ...
      <SelectPrimitive.ItemText className="flex-1 overflow-hidden text-ellipsis">
        {children}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        "flex cursor-default items-center justify-center py-2 min-h-[40px]",
        className,
      )}
      {...props}
    >
