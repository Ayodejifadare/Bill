...
export function SettingsScreen({ onNavigate }: SettingsScreenProps) {
  ...
  const [settings, setSettings] = useState<SettingsState>(() =>
    toSettingsState(initialPreferences),
  );
  ...
  const fromUserSettingsPayload = (
    ...
    notifications: {
      ...
      whatsappNotifications: Boolean(
        payload.notifications.whatsappNotifications,
      ),
    ...
    preferences: {
      ...
      currency: String(
        payload.preferences.currency ?? appSettings.currency ?? "USD",
      ).toUpperCase(),
  ...
  const syncCurrencyToAppSettings = (currencyCode?: string) => {
    ...
    const updates: { currency: string; region?: string } = {
      currency: normalized,
    };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (updated) {
        const nextState = fromUserSettingsPayload(
          updated as UserSettingsPayload,
        );
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("notifications", "transactionAlerts", checked)
                }
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("privacy", "twoFactorAuth", checked)
                }
              />
            </div>
