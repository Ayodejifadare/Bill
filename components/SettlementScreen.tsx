      ...
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Transfer collected funds</p>
          </div>
        </div>
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">{billSplit.description}</p>
            </div>
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{billSplit.participants.filter(p => p.hasPaid).length}/{billSplit.participants.length} paid</span>
            </div>
          </div>
        </Card>
          ...
          <Card className="p-4 border-success">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                All participants have paid their shares. Transfer funds to the intended recipient.
              </p>
        ...
        {billSplit.status === 'collecting' && (
          <Alert>
            ...
            <AlertDescription>
              Transfer will be available once all participants have paid their shares.
            </AlertDescription>
          </Alert>
        )}
      </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Transfer to external account</p>
          </div>
        </div>
            ...
            <div>
              ...
              {recipientName && (
                <div className="mt-2 p-3 bg-muted rounded text-center">
                  <p className="font-medium text-sm">{recipientName.toUpperCase()}</p>
                </div>
              )}
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input
                  ...
                  value={transferFullAmount ? billSplit.collectedAmount.toFixed(2) : transferAmount}
                  onChange={(e) => !transferFullAmount && setTransferAmount(e.target.value)}
                  disabled={transferFullAmount}
                />
              </div>
              {!transferFullAmount && parseFloat(transferAmount) > billSplit.collectedAmount && (
              ...
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg mt-3">
                <div>
                  <Label htmlFor="transfer-full" className="font-medium">Transfer Full Amount</Label>
                  <p className="text-xs text-muted-foreground">Transfer entire available balance</p>
                </div>
                <Switch
                  id="transfer-full"
      ...
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Confirm transfer details</p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span>{transferFullAmount ? 'Full Amount' : 'Custom Amount'}</span>
              </div>
              {narration && (
                <div className="flex justify-between">
        ...
        <Alert>
          ...
          <AlertDescription>
            Bank transfers typically process within 1-3 business days. This action cannot be undone.
          </AlertDescription>
        </Alert>
      ...
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Transfer has been initiated</p>
          </div>
        </div>
        ...
        <Card className="p-6">
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Your transfer is being processed</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-success">${finalAmount.toFixed(2)}</p>
